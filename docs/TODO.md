...
Việc G2 còn dang dở (đường tới "G2 ships"): theo bảng milestone + graduation criteria (roadmap:194-195):

Tier 3b VirtIO-GPU backend (Linux VM graphics) — 📋.
...
Desktop đầy đủ (compositor + mouse, windowed) — 📋; VFS scale (ext4/large disk) — 📋; full utility suite (grep/sed/awk/top) — 📋.
