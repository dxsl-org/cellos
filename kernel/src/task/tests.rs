...
mod tests {
    ...
    fn test_scheduler_task_table() {
        ...
        // Spawn a task
        let id = sched.spawn("test-task", types::CellId(0), Vec::new());
    ...
    fn test_ipc_send_no_receiver() {
        ...
        let sender_id = sched.spawn("sender", types::CellId(0), Vec::new());
        let receiver_id = sched.spawn("receiver", types::CellId(0), Vec::new());
    ...
    fn test_scheduler_current_task() {
        ...
        // Spawn and schedule
        let id = sched.spawn("test", types::CellId(0), Vec::new());
        sched.schedule();
    ...
    fn test_multiple_tasks_ready_queue() {
        ...
        // Spawn 3 tasks
        let id1 = sched.spawn("task1", types::CellId(0), Vec::new());
        let id2 = sched.spawn("task2", types::CellId(0), Vec::new());
        let id3 = sched.spawn("task3", types::CellId(0), Vec::new());
