...
impl FrameAllocator {
    ...
    pub fn new_from_map(entries: &[MemoryMapEntry]) -> Self {
        ...
        // Align start to 4KB
        let mut aligned_start = (best_start + PAGE_SIZE - 1) & !(PAGE_SIZE - 1);
    ...
    fn mark_used(&mut self, idx: usize) {
        ...
        self.bitmap[u64_idx] |= 1 << bit_offset;
    }
...
pub static FRAME_ALLOCATOR: crate::sync::Spinlock<Option<FrameAllocator>> = crate::sync::Spinlock::new(None);
