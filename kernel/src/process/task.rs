...
pub enum TaskState {
    ...
    Sending { target: usize, msg_ptr: usize, msg_len: usize },
...
pub struct Lease {
    ...
    pub ptr: usize,   // Address in Task's space
...
pub struct Task {
    ...
    // Maps FD -> Path/Resource
    pub open_files: alloc::collections::BTreeMap<usize, String>,
...
impl Task {
    pub fn new(id: usize, name: &str, allowed_drivers: Vec<usize>) -> Self {
        Self {
            id,
    ...
    pub fn add_lease(&mut self, ptr: usize, len: usize, attributes: LeaseAttributes) -> usize {
    ...
    // --- Grant Table Methods ---
    pub fn add_grant(&mut self, ptr: usize, len: usize, flags: u32, sender_id: usize) -> usize {
