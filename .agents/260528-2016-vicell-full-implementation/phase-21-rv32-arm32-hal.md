...
Bring up the two 32-bit architectures as production HAL targets: RISC-V 32 (RV32) and ARM AArch32 (32-bit ARMv7-A). Reuses architectural patterns from Phases 03 (RV64) and 08 (AArch64); the work is largely paging-format and CPU-mode differences. After this phase, ViCell boots on 5 architectures total, covering embedded-class 32-bit targets.
