...
- **Protocol decision (Validation Session 1): Custom `ViSurface` trait** in `libs/api/src/display.rs`. NOT Wayland wire protocol — simpler, native ViCell design. Wayland compat deferred to v1.x. <!-- Updated: Validation Session 1 -->
