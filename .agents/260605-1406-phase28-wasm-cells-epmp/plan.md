...
**Status**: PARTIAL/SUSPECT (D38 correction, 2026-08-01)  
**Priority**: P2  
**Target**: 2026-09-22  
**Effort**: ~5 weeks  
**Created**: 2026-06-05

> WASM crates remain tracked in the workspace, but their product/runtime qualification
> and retain-vs-remove disposition are unresolved. ePMP requires an M-mode owner absent
> from the current runtime. This plan is not active; resolve the WASM disposition before
...
## Historical planning baseline (2026-06-05; superseded by D38 evidence)

> Do not use this table as current source truth. As of 2026-08-01,
> `cells/drivers/wasm` uses `wasmi` and `cells/tools/wasm` provides the host app. Current
> runtime/product qualification and retain-vs-remove disposition remain unresolved; ePMP
> is still blocked on an M-mode owner.
