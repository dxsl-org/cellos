...
- [x] Verify builds/tests and scope guard.
## Success Criteria
...
## Next Steps
Run QEMU runtime evidence when `disk_v3.img` is available; host/RISC-V build,
focused regressions, production review, and living-doc sync are complete.
