...
|---|---|---:|---|
| `artifacts/approval-input-manifest.json` | `85a1aebe52ae15a396a69b6fca6b5fe6eb2fb66b9cb16bf3f66ac5d1aecff8a7` | 106 | package verified; security backing and human approval blocked |
...
Pinned source identity is nightly `2026-05-01`, rustc `1.97.0-nightly (f53b654a8)`. The support map's 46-file source-manifest digest is `b984d50da89e342974ada8822321edd6b1d091d1da3dcf8ec1819a8986a4b105`; its six-entry kernel security-backing inventory digest is `62c7149a522a94c148da318ec1a1846985d78f7b23d0d5e03bb9e7fd95c03df6`; and the support-map file digest bound by the canonical manifest is `87b0a5783eb9858667fe379a7e0961af917b7c98173108302e5d033c465f735a`.

## Reconciliation

The map covers all 27/27 private/public module declarations at pinned `library/std/src/sys/mod.rs:3-30` and mechanically scopes 36/36 hook IDs with 8 Supported, 10 Unsupported, 18 Deferred, zero omitted modules, and zero unclassified/duplicate/evidence-free hooks. Blocking Deferred rows include `PAL-019` entropy, `PAL-031` pending named approval of completed raw-syscall technical backing, `PAL-025` thread query/yield behavior, and target-sensitive builtins, personality, cmath, and env-constant surfaces. No Supported row depends on the contradicted `GetRandom` enforcement.
...
Approval absence is a hard blocker and is never inferred. All six approval rows are unsigned `NOT GRANTED` records bound to approval-input-manifest digest `85a1aebe52ae15a396a69b6fca6b5fe6eb2fb66b9cb16bf3f66ac5d1aecff8a7`; package verification, a conditional recommendation, or either independent review grants no human approval.

## Non-Waivable Blockers and Risks

Umbrella Phase 03 design, external-floor, provenance, production integration, hostile/physical evidence, authenticated retention, release, and ledger gates remain open. Umbrella Phase 06 remains pending. `PAL-019` remains Deferred until its production entropy prerequisite is implemented and evidenced. `PAL-031` technical backing/evidence is complete but remains Deferred pending named approval of this governed rebind. The exact six-path kernel security-backing inventory is a closed approval input; path or digest drift invalidates the package. A frozen ABI change requires 2× explicit confirmation. Any source/toolchain/kernel tuple/loader/allocator/thread/panic/capability/workload/schema drift invalidates affected approval and restores `NO_GO`.
