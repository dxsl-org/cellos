...
| 5 | [Nonce-Bound Signed-Time Service](./phase-05-nonce-bound-signed-time-service.md) | in progress; protocol, KMS key/signer, allocation, receipt, record, transaction, and snapshot `SOFTWARE_HARNESS` cores complete | 2 |
