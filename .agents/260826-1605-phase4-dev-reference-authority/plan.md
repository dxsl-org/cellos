...
| 5 | [Nonce-Bound Signed-Time Service](./phase-05-nonce-bound-signed-time-service.md) | in progress; protocol/request, KMS, persistence/receipt-first recovery, clock-policy, and manifest `SOFTWARE_HARNESS` cores complete | 2 |
