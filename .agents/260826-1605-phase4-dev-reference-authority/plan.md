...
| 5 | [Nonce-Bound Signed-Time Service](./phase-05-nonce-bound-signed-time-service.md) | in progress; request-bound handler, protocol, KMS, persistence/recovery, clock-policy, manifest, CloudFormation/IAM, and production-rejection handoff `SOFTWARE_HARNESS` cores complete; authenticated clock adapter blocked on provider contract | 2 |
