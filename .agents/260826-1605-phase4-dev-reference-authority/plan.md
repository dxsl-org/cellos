...
| 5 | [Nonce-Bound Signed-Time Service](./phase-05-nonce-bound-signed-time-service.md) | in progress; protocol, KMS, persistence, and clock-policy `SOFTWARE_HARNESS` cores complete | 2 |
