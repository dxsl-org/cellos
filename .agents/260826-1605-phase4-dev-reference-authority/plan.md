...
| 5 | [Nonce-Bound Signed-Time Service](./phase-05-nonce-bound-signed-time-service.md) | in progress; codec, vectors, KMS signer, allocation, and receipt cores `SOFTWARE_HARNESS` complete | 2 |
