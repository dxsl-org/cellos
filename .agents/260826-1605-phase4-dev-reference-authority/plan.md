...
| 4 | [STM32 and TPM Protected Authority](./phase-04-stm32-tpm-protected-authority.md) | blocked on certificate-chain transport; dual-slot journal `SOFTWARE_HARNESS` complete | 2, Phase 2 protocol review |
