...
| 5 | [Nonce-Bound Signed-Time Service](./phase-05-nonce-bound-signed-time-service.md) | in progress; strict codec, vectors, KMS signer, and allocation core `SOFTWARE_HARNESS` complete | 2 |
