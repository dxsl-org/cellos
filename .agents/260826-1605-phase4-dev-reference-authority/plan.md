...
| 5 | [Nonce-Bound Signed-Time Service](./phase-05-nonce-bound-signed-time-service.md) | blocked; `SOFTWARE_HARNESS` protocol/provider/allocator-lineage cores complete, while Cloudflare live draft-11 compatibility, artifact scripts, AWS authorization, deployment, and live restore/fork/security evidence remain open | 2 |
