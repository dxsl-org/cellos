...
- **Law 1 confirmations are still owed**: the interface landed so the slice could be verified. The
  two explicit owner confirmations must be recorded before this is treated as frozen.
