...
typing `ai-test` at the shell (bare name: the shell resolves it under `/bin`), and writes a timestamped transcript with the verdict to
...
`-DriveShell:$false` and type `ai-test` yourself.
