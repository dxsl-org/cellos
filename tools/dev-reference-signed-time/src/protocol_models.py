...
MAX_RESPONSE_SIGNATURE_OVERHEAD = 1 + 2 + 71  # label 15, bstr header, low-S P-256 DER
MAX_UNSIGNED_RESPONSE_BYTES = MAX_RESPONSE_BYTES - MAX_RESPONSE_SIGNATURE_OVERHEAD
MAX_UINT64 = (1 << 64) - 1
