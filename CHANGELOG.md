...
- pcie: preserve exclusive Driver Cell BDF ownership and DMA pins across competing probes or unacknowledged IOMMU publication/teardown, with spec-correct RISC-V IODIR/IOTINVAL/IOFENCE batches
