...
fn shell_utils_all_scenarios_pass() {
    ...
    for marker in [
        ...
        "[shell-test] PASS  shell rm -i keeps file on decline",
        "[shell-test] PASS  shell rm -i deletes file on confirm",
        "[shell-test] PASS  shell ls lists root mount points",
        "[shell-test] PASS  shell rmdir protected mount point fails",
        "[shell-test] PASS  shell mkdir -v outputs diagnostic",
        "[shell-test] PASS  shell rmdir -p removes parent directories",
        "[shell-test] PASS  shell ls -F appends slash to dirs",
        "[shell-test] PASS  shell ls -l prints type and size",
        "[shell-test] PASS  shell cp copies file into target directory",
        "[shell-test] PASS  shell cp -r copies directory recursively",
        "[shell-test] PASS  shell mv moves file into target directory",
        "[shell-test] PASS  shell mv removes original file",
        "[shell-test] PASS  shell history lists recorded commands",
        "[shell-test] PASS  shell history -c clears history",
        "[shell-test] PASS  shell cat reads from pipeline stdin",
    ] {
        assert!(
