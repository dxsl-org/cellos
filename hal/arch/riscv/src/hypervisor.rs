...
impl ViHypervisor for RiscV64Hypervisor {
    ...
    fn create_vcpu(&self, _: &mut Self::Vm) -> ViResult<Self::Vcpu> {
        Err(ViError::NotSupported)
    }
    fn map_guest(
        &self,
        _: &mut Self::Stage2Table,
        _: u64,
        _: u64,
        _: usize,
        _: bool,
    ...
    fn run_vcpu(&self, _: &mut Self::Vcpu) -> ViResult<ViVmExit> {
        Err(ViError::NotSupported)
    }
    fn inject_irq(&self, _: &mut Self::Vcpu, _: u32) -> ViResult<()> {
        Err(ViError::NotSupported)
    }
}
