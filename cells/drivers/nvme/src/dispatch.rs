...
// reason: VFS does not yet call these encoders directly (it builds requests
// inline); kept as the documented counterpart to parse_op() for that caller.
#[allow(dead_code)]
