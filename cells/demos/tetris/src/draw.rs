...
use crate::game::{
    piece_cells, Game, BG_COLOR, BORDER_COLOR, COLS, GHOST_COLOR, PANEL_COLOR, PIECE_COLORS, ROWS,
    TEXT_COLOR,
};
...
pub fn render(surf: &mut ViSurface, game: &Game) {
    ...
    fill(
        ...
        BX - 2,
        BY - 2,
        COLS as u32 * CELL_PX + 4,
        ROWS as u32 * CELL_PX + 4,
        BORDER_COLOR,
    );
    fill(
        surf,
